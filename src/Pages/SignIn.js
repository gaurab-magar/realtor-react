...
export const SignIn = () => {
  ...
  return (
    <div className="flex justify-center flex-wrap items-center p-6 py-12 max-w-6xl mx-auto">
      ...
      <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
        ...
        <form>
          ...
          <input id='email' className='w-full px-4 py-2 mb-4' type='text' value={email} onChange={onChange} placeholder='example@gmail.com' />
          <div className='relative'>
            <label htmlFor='password' className='text-white'>password</label>
            <input id='password' className='w-full px-4 py-2 mb-4' type='password' value={password} onChange={onChange} placeholder='**********' />
            {show ? (
        ...
        <div className='flex justify-between text-slate-400 w-full'>
            ...
            <p>
              <Link to='ForgotPass' className='text-blue-200 hover:text-blue-500'>Forgot password ?</Link>  
            </p>
        </div>
        ...
        <button type='submit' className='my-2 bg-red-800 text-white w-full font-bold rounded-full py-2 hover:bg-red-900 hover:text-gray-50 transition duration-300 ease-out active:bg-red-950'>
